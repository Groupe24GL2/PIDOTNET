namespace PIDOTNET.DATA.DataModel
{
    ...
    [Table("pi4gl.[pi4gl.ficheevaluation]")]
    public partial class pi4gl_ficheevaluation
    {
        [Key]
        [Column(Order = 0)]
        ...
        public virtual pi4gl_employee pi4gl_employee { get; set; }

        public virtual pi4gl_evaluation pi4gl_evaluation { get; set; }
    }
}
